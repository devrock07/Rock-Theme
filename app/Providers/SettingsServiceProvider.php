...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'branding:login_media',
        'branding:login_title',
        'branding:login_subtitle',
        'branding:console_background',
        'branding:console_background_opacity',
        'branding:console_font_size',
        'branding:console_scanlines',
        'branding:status_enabled',
        'branding:status_title',
        'branding:status_message',
        'branding:status_show_nodes',
        'branding:status_node_mode',
        'branding:announcement_enabled',
        'branding:announcement_message',
        'branding:announcement_type',
