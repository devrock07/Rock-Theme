    ...
    return (
        <>
            ...
            <button
                ...
                css={tw`inline-flex min-w-[2.75rem] min-h-[2.75rem] items-center justify-center text-sm p-2 text-neutral-500 hover:text-red-600 transition-colors duration-150`}
